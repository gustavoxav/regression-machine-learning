...
fig.suptitle(f'Arvore de Decisao — Melhor Resultado\n{nome_melhor} | max_depth={depth_melhor} | R²={melhor_row["r2_score"]:.4f}',
...
axes[2].barh(range(len(indices_top)), importancias[indices_top], align='center', color='mediumpurple', alpha=0.8)
