# -*- coding: utf-8 -*-
"""
Pré-processamento - Com Dummy, Sem Padronização
...
NOME_PREPROCESSAMENTO = 'com_dummy_sem_std'
...
# Usando One-Hot Encoding (variáveis dummy) para colunas categóricas
...
# Sem padronização nesta variação
